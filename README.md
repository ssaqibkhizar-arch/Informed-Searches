...
The agent is capable of finding the optimal/sub-optimal path to a target and includes a **Dynamic Mode**, where random obstacles can spawn in real-time while the agent is moving. If the path is blocked, the agent immediately detects the collision and recalculates a new path from its current position.
...
To run this project, you must have Python 3.x installed on your system along with the `pygame` library.

### Installation Instructions

1. **Clone the repository to your local machine:**
   ```bash
   git clone [https://github.com/ssaqibkhizar-arch/Informed-Searches.git](https://github.com/ssaqibkhizar-arch/Informed-Searches.git)